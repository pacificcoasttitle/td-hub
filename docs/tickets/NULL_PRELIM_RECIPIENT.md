...
**Independently counted here** (orders with no party carrying an email —
a DIFFERENT definition from `resolvePrelimRecipients`, so not a restatement
of the 1,101): **19 hub-created, 170 synced.**
