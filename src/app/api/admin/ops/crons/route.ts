...
const CRON_SCHEDULES: Record<string, string> = {
  ...
  'softpro.sync_contacts.order_contact_person': 'Hourly :05 UTC (:05 PT offset by -7/-8h), 16h per-type cooldown',
  'softpro.sync_contacts.title_officer': 'Every 3h :15 UTC (:15 PT offset by -7/-8h), 16h per-type cooldown',
  'softpro.sync_contacts.escrow_officer': 'Every 3h :25 UTC (:25 PT offset by -7/-8h), 16h per-type cooldown',
  'softpro.sync_contacts.sales_rep': 'Every 3h :35 UTC (:35 PT offset by -7/-8h), 16h per-type cooldown',
