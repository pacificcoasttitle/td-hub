...
/**
 * The full-width table hub, unchanged in behaviour and moved here verbatim so
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="sticky top-0 z-20 bg-white border-b border-gray-200 px-4 py-2 flex items-center gap-2 shrink-0">
        ...
        <button
          ...
          className="h-9 px-3 border border-gray-200 rounded-lg text-xs font-semibold bg-white text-[#3C4557] hover:bg-gray-50 shrink-0"
        >
          Split
        </button>
