...
import { StepSelectOrder, OrderSummaryBanner, SummaryField, FormField } from './step-select-order';
  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
        ...
        {step === 4 && <StepLenderInfo lender={lender} setLender={setLender} onProceed={() => setStep(5)} />}
        {step === 5 && (
