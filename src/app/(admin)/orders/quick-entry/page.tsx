      ...
      <div className="max-w-2xl mx-auto p-8">
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="p-6 flex gap-3">
            <Link href={`/orders/${s.result.orderId}`} className="flex-1 inline-flex items-center justify-center px-5 py-3 text-sm font-medium bg-[#C5A55A] text-white rounded-lg hover:bg-[#B8953D] transition-colors h-11">
              View Order
            </Link>
            <button onClick={() => { s.setResult(null); window.scrollTo(0, 0); }} className="flex-1 inline-flex items-center justify-center px-5 py-3 text-sm font-medium border border-gray-200 text-[#4B5563] rounded-lg hover:bg-gray-50 transition-colors h-11">
              Create Another
            </button>
          </div>
        </div>
