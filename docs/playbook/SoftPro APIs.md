...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/create](http://100.29.181.61:3000/api/ordercreation/create)  
**Staging:** 8081  
**Production:** 3000  
**Method:** `POST`  
**Request:**
...
1. OrderType can have values:  
   * 1.1 Title only  
   * 1.2 Title & Escrow  
   * 1.3 Escrow only  
2. In personalDetails, we can add the values of 4 contacts depending on the userType. It can have the values:  
...
3. As the seller/buyer can be associated with an organization or an individual, IsOrganization is used for specifying it. Add true if it’s organisation. For borrowers, these details are mentioned in transactionDetails.

## **2\. Add Documents (Bulk)**

**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/AddDocuments](http://100.29.181.61:3000/api/ordercreation/AddDocuments)  
**Method:** `POST`  
**Request:**  
json  
\[  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetAttachedDocuments](http://100.29.181.61:3000/api/ordercreation/GetAttachedDocuments)  
**Method:** `GET`  
**Parameters:**
...
{  
   ...
   "Message": "Success",  
   "data": \[  
       "http://100.29.181.61/SoftProIntegrate/assets/DocumentName\_HHmmss.pdf"  
   \]  
}  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetAttachedDocumentsPrelim](http://100.29.181.61:3000/api/ordercreation/GetAttachedDocumentsPrelim)  
**Method:** `GET`  
**Parameters:**
...
{  
   ...
   "Message": "Success",  
   "data": \[  
       "http://100.29.181.61/SoftProIntegrate/assets/PrelimDoc\_HHmmss.pdf"  
   \]  
}  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetAttachedDocumentsPolicy](http://100.29.181.61:3000/api/ordercreation/GetAttachedDocumentsPolicy)  
**Method:** `GET`  
**Parameters:**
...
{  
   ...
   "data": \[  
       {  
           ...
           "FileUrl": "http://100.29.181.61/SoftProIntegrate/assets/Policy\_HHmmss.pdf"  
       }  
   \]  
}  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetAttachedDocumentsFromOrders](http://100.29.181.61:3000/api/ordercreation/GetAttachedDocumentsFromOrders)  
**Method:** `GET`  
**Parameters:**
...
\[  
   {  
       ...
       "OrderNumber": "20001314-OCT",  
       "data": \[  
           "http://100.29.181.61/SoftProIntegrate/assets/Prelim\_HHmmss.pdf"  
       \]  
   }  
\]  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetPrelim](http://100.29.181.61:3000/api/ordercreation/GetPrelim)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/AddNotes](http://100.29.181.61:3000/api/ordercreation/AddNotes)  
**Method:** `POST`  
**Request:**  
json  
\[  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/AddTask](http://100.29.181.61:3000/api/ordercreation/AddTask)  
**Method:** `POST`  
**Request:**  
json  
\[  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetOrderStatus](http://100.29.181.61:3000/api/ordercreation/GetOrderStatus)  
**Method:** `GET`  
**Response:**  
json  
{  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetOrderMarketingRep](http://100.29.181.61:3000/api/ordercreation/GetOrderMarketingRep)  
**Method:** `GET`  
**Response:**  
json  
{  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/CreateUser](http://100.29.181.61:3000/api/ordercreation/CreateUser)  
**Method:** `POST`  
**Request:**  
json  
{  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/UpdateUser](http://100.29.181.61:3000/api/ordercreation/UpdateUser)  
**Method:** `POST`  
**Request:**  
json  
{  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/UpdateCompany](http://100.29.181.61:3000/api/ordercreation/UpdateCompany)  
**Method:** `POST`  
**Request:**  
json  
{  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetTitleEscrowUsers](http://100.29.181.61:3000/api/ordercreation/GetTitleEscrowUsers)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetFilteredOrders](http://100.29.181.61:3000/api/ordercreation/GetFilteredOrders)  
**Method:** `GET`  
**Request:**  
json  
{  
...
{  
   "Status": 200,  
   "Message": "Success",  
   "data": "http://100.29.181.61/SoftProIntegrate/assets/SalesReport/SalesReport\_20240101\_HHmmss.xls"  
}  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/AddCompany](http://100.29.181.61:3000/api/ordercreation/AddCompany)  
**Method:** `POST`  
**Request:**  
json  
{  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetOrderDetails](http://100.29.181.61:3000/api/ordercreation/GetOrderDetails)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetMilestoneNotification](http://100.29.181.61:3000/api/ordercreation/GetMilestoneNotification)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/updateOrder](http://100.29.181.61:3000/api/ordercreation/updateOrder)  
**Method:** `POST`  
**Request:**  
json  
{  
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetOrderContacts](http://100.29.181.61:3000/api/ordercreation/GetOrderContacts)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetFees](http://100.29.181.61:3000/api/ordercreation/GetFees)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetPrelimSummary](http://100.29.181.61:3000/api/ordercreation/GetPrelimSummary)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/ordercreation/GetOrders](http://100.29.181.61:3000/api/ordercreation/GetOrders)  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/powerbi/createExcel](http://100.29.181.61:3000/api/powerbi/createExcel)  
**Staging:** 8081  
**Production:** 3000  
**Method:** `GET`  
**Parameters:**
...
1. The API filters data based on the month of the provided `userPostedDate`.  
2. It specifically includes entries where `BillCode` is one of: `TPC`, `TPW`, `UPRE`, `TSGW`, or `ESC`.  
3. The response includes a list of rows containing order numbers, transaction dates, contact names, and financial amounts.

## 2\. Get Opening Data

**API URL:**  
[http://100.29.181.61:3000/api/powerbi/getOpeningData](http://100.29.181.61:3000/api/powerbi/getOpeningData?userPostedDate=2025-10-01)  
**Staging:** 8081  
**Production:** 3000  
**Method:** `GET`  
**Parameters:**
...
**API URL:**  
[http://100.29.181.61:3000/api/lookup/GetLookUpTable](http://100.29.181.61:3000/api/lookup/GetLookUpTable)  
**Staging:** 8081  
**Production:** 3000  
**Method:** `GET`  
**Parameters:**
...
1. `userType` must match the name of a lookup table in SoftPro (e.g., "Escrow Company", "Lender", "Title Officer").  
2. For "Title Officer" and "Escrow Officer" tables, the API automatically resolves the `Officer Name` and `Email` from the SoftPro Security Manager based on the user's lookup code.  
3. The response is returned as a list of objects representing the rows in the lookup table
